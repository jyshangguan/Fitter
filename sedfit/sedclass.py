...
class SedClass(bc.DataSet):
    ...
    def filtering(self, bandName, modelFunc):
        """
        ...
        modelFunc : function
            The model function taking wavelength and return the model flux density.
    ...
    def model_pht(self, modelFunc):
        ...
        for bandName in bandNameList:
            fluxList.append(self.filtering(bandName, modelFunc)[1])
        return fluxList
