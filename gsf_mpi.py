...
def fitter(sedData, sedModel, unctDict, parTruth, emceeDict, pool):
    """
...
def gsf_fitter(configName, pool, targname=None, redshift=None, distance=None, sedFile=None):
    """
    ...
    em = fitter(sedData, sedModel, unctDict, parTruth, emceeDict, pool)
